...
Use the output from `journal-positioning-agent` to identify the paper's:
...
The goal is not to create a generic literature survey. The goal is to help the manuscript explain what prior research has established, what remains unresolved, and how the focal paper advances marketing knowledge.
...
If citations are missing, mark them as `[NEEDS CITATION: describe missing citation]`.
...
Do not invent data. If a figure or table requires missing data, mark it as `[NEEDS DATA: describe required data]`.
...
2. marketing theory and contribution reviewer
...
- reviewer_risk_report.md
- revision_plan.md
- acceptance_risk_score.json

### Step 7. Final manuscript assembly

After section writing and reviewer simulation, assemble the final draft outputs into:

- workspace/outputs/full_manuscript.md
- workspace/outputs/abstract.md
- workspace/outputs/introduction.md
- workspace/outputs/theory_background.md
- workspace/outputs/data_and_setting.md
- workspace/outputs/empirical_strategy.md
- workspace/outputs/results.md
- workspace/outputs/robustness.md
- workspace/outputs/discussion.md
- workspace/outputs/managerial_implications.md
...
- Do not invent coefficients, p-values, sample sizes, model specifications, or robustness checks.
- Do not overclaim causality.
- Do not write generic AI-style contribution paragraphs.
- Do not create citations that have not been verified or supplied.
...
- If a required table or figure is missing, write `[NEEDS TABLE/FIGURE: describe missing item]`.
- If the empirical design cannot support the causal claim, explicitly say so and soften the claim.
- Keep all claims consistent with the supplied input files.
- Preserve uncertainty when the input materials are incomplete.
...
The writing should be empirical, disciplined, and contribution-oriented.
...
The writing should be precise, transparent, and methodologically rigorous.
...
The writing should be more accessible and managerially meaningful while remaining theoretically rigorous.

## Output quality standards

A strong MarketingOrchestra output should:

- clearly explain why the phenomenon is a marketing phenomenon
- state a precise research question
- connect the paper to specific marketing literature streams
- articulate substantive, theoretical, empirical, and managerial contributions
- explain the empirical setting transparently
- describe the research design without overclaiming
- interpret results carefully
- address alternative explanations and robustness
- provide specific managerial implications
- identify reviewer risks before submission

## Failure modes to avoid

Avoid:

- generic claims about AI changing the world
- generic claims about contributing to marketing
- literature reviews that only summarize papers without building an argument
- results sections that only list statistical significance
- unsupported mechanism claims
- managerial implications that are too broad or obvious
- causal language that exceeds the research design
- invented references, coefficients, sample sizes, or robustness checks
